...
/* ENUM:VOID (./gtkmarshalers.list:44) */
void
...
/* INT:POINTER (./gtkmarshalers.list:45) */
void
...
/* NONE:BOOLEAN (./gtkmarshalers.list:46) */

/* NONE:ENUM (./gtkmarshalers.list:47) */

/* NONE:INT (./gtkmarshalers.list:48) */

/* NONE:INT,BOOL (./gtkmarshalers.list:49) */
void
...
/* NONE:INT,INT (./gtkmarshalers.list:50) */
void
...
/* NONE:NONE (./gtkmarshalers.list:51) */

/* NONE:STRING,INT,POINTER (./gtkmarshalers.list:52) */
void
...
/* STRING:DOUBLE (./gtkmarshalers.list:53) */
void
...
/* VOID:BOOLEAN (./gtkmarshalers.list:55) */

/* VOID:BOOLEAN,BOOLEAN,BOOLEAN (./gtkmarshalers.list:56) */
void
...
/* VOID:BOXED (./gtkmarshalers.list:57) */

/* VOID:BOXED,BOXED (./gtkmarshalers.list:58) */
void
...
/* VOID:BOXED,BOXED,POINTER (./gtkmarshalers.list:59) */
void
...
/* VOID:BOXED,OBJECT (./gtkmarshalers.list:60) */
void
...
/* VOID:BOXED,STRING,INT (./gtkmarshalers.list:61) */
void
...
/* VOID:BOXED,UINT (./gtkmarshalers.list:62) */
void
...
/* VOID:BOXED,UINT,FLAGS (./gtkmarshalers.list:63) */
void
...
/* VOID:BOXED,UINT,UINT (./gtkmarshalers.list:64) */
void
...
/* VOID:ENUM (./gtkmarshalers.list:65) */

/* VOID:ENUM,BOOLEAN (./gtkmarshalers.list:66) */
void
...
/* VOID:ENUM,ENUM (./gtkmarshalers.list:67) */
void
...
/* VOID:ENUM,FLOAT (./gtkmarshalers.list:68) */
void
...
/* VOID:ENUM,FLOAT,BOOLEAN (./gtkmarshalers.list:69) */
void
...
/* VOID:ENUM,INT (./gtkmarshalers.list:70) */
void
...
/* VOID:ENUM,INT,BOOLEAN (./gtkmarshalers.list:71) */
void
...
/* VOID:OBJECT (./gtkmarshalers.list:76) */

/* VOID:OBJECT,BOOLEAN (./gtkmarshalers.list:77) */
void
...
/* VOID:OBJECT,BOXED,BOXED (./gtkmarshalers.list:78) */
void
...
/* VOID:OBJECT,BOXED,UINT,UINT (./gtkmarshalers.list:79) */
void
...
/* VOID:OBJECT,INT,INT (./gtkmarshalers.list:80) */
void
...
/* VOID:OBJECT,INT,INT,BOXED,UINT,UINT (./gtkmarshalers.list:81) */
void
...
/* VOID:OBJECT,OBJECT (./gtkmarshalers.list:82) */
void
...
/* VOID:OBJECT,STRING (./gtkmarshalers.list:83) */
void
...
/* VOID:OBJECT,STRING,STRING (./gtkmarshalers.list:84) */
void
...
/* VOID:OBJECT,UINT (./gtkmarshalers.list:85) */
void
...
/* VOID:OBJECT,UINT,FLAGS (./gtkmarshalers.list:86) */
void
...
/* VOID:OBJECT,STRING (./gtkmarshalers.list:87) */

/* VOID:POINTER (./gtkmarshalers.list:88) */

/* VOID:POINTER,INT (./gtkmarshalers.list:89) */
void
...
/* VOID:POINTER,BOOLEAN (./gtkmarshalers.list:90) */
void
...
/* VOID:POINTER,POINTER,POINTER (./gtkmarshalers.list:91) */
void
...
/* VOID:POINTER,UINT (./gtkmarshalers.list:92) */
void
...
/* VOID:STRING (./gtkmarshalers.list:93) */

/* VOID:STRING,STRING (./gtkmarshalers.list:94) */
void
...
/* VOID:STRING,INT,POINTER (./gtkmarshalers.list:95) */

/* VOID:STRING,UINT,FLAGS (./gtkmarshalers.list:96) */
void
...
/* VOID:UINT,FLAGS,BOXED (./gtkmarshalers.list:97) */
void
...
/* VOID:UINT,UINT (./gtkmarshalers.list:98) */
void
...
/* VOID:UINT,STRING (./gtkmarshalers.list:99) */
void
...
/* VOID:UINT,BOXED,UINT,FLAGS,FLAGS (./gtkmarshalers.list:100) */
void
...
/* VOID:UINT,OBJECT,UINT,FLAGS,FLAGS (./gtkmarshalers.list:101) */
void
...
/* VOID:VOID (./gtkmarshalers.list:102) */
