...
ZIP=/tmp/gtk+-2.8.0-`date +%Y%m%d`.zip
DEVZIP=/tmp/gtk+-dev-2.8.0-`date +%Y%m%d`.zip
cd /usr/local
rm $ZIP
...
zip $ZIP lib/gtk-2.0/2.4.0/loaders/*.dll lib/gtk-2.0/2.4.0/immodules/*.dll lib/gtk-2.0/2.4.0/engines/*.dll
